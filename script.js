    ...
    decreaseScore(value) {
        ...
        if (this.score - value <= 0) {
            ...
            if (localStorage.getItem("record") < this.record) {
                ...
                share.innerHTML = VK.Share.button({url: 'https://andreydem0505.github.io/Halloween', title: 'Мой новый рекорд: ' + this.record,
                        image: 'https://andreydem0505.github.io/Halloween/pumpkin.png'}, {type: 'link', text: 'Поделиться'});
